...
Site sections (in order): **Hero → Now → Story → Contact**. Nav: Now · My Story · Contact.
...
- **Hover states**: links/ghost → accent L1; primary button → accent D1; secondary → accent tint. Token names follow this convention (e.g. `--accent-d1`).
